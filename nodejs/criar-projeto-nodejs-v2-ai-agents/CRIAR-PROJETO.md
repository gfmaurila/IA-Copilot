...
## Orquestração por agentes - v2

Além das Rules/Skills/Specs, este template usa o fluxo definido em `AGENTS.md` e `orchestration/`.

Antes de implementar qualquer Spec nova, materializar:
- `tasks/generated/REQUIREMENTS.md`
- `tasks/generated/ARCHITECTURE_PLAN.md`
- `tasks/generated/EXECUTION_PLAN.md`

A conclusão exige os Quality Gates aplicáveis e os relatórios de teste/review.

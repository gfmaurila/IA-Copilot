...
# Orquestração por Agentes de IA

Este template utiliza uma camada de orquestração inspirada em fluxos de software agents.

## Sequência obrigatória para criação/refatoração relevante
...
Os agentes não substituem Laravel, CQRS, Rules, Skills ou Specs. Eles coordenam essas fontes.

Antes de implementar, devem existir:
...
A conclusão depende dos gates definidos em:

# Base Laravel + SQL Server - AI Agents

Template para criação e evolução automatizada de projetos Laravel + React + SQL Server usando Rules, Skills, Specs e agentes especializados.

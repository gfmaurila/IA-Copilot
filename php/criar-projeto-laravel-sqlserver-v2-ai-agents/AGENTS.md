# AGENTS - Laravel + SQL Server

Este template utiliza agentes especializados para criar, evoluir e revisar projetos Laravel + SQL Server de forma controlada, preservando as convenções nativas do framework.
...
| Architect | definir arquitetura Laravel, SQL Server, segurança e integrações | `tasks/generated/ARCHITECTURE_PLAN.md` |
...
| Reviewer | revisar Laravel, SQL Server, segurança e qualidade | `tasks/reports/REVIEW_REPORT.md` |

...
Antes de alterar código, executar o fluxo:
...
Os três artefatos de planejamento são obrigatórios: `REQUIREMENTS.md`, `ARCHITECTURE_PLAN.md` e `EXECUTION_PLAN.md`.

Os Quality Gates estão em `orchestration/gates/QUALITY_GATES.md`.

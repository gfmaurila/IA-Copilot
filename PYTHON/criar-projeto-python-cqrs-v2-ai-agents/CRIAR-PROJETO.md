...
Artefatos obrigatórios antes do código:

- `tasks/generated/REQUIREMENTS.md`
- `tasks/generated/ARCHITECTURE_PLAN.md`
- `tasks/generated/EXECUTION_PLAN.md`

A conclusão exige aprovação dos Quality Gates definidos em `orchestration/gates/QUALITY_GATES.md`.

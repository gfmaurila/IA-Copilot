# FE-ADMIN-27 — Contato - Mensagens Recebidas

## Objetivo

Listagem das mensagens enviadas através do formulário de contato do site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/contato/mensagens`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/27 - Contato - Mensagens Recebidas.png`

# FE-ADMIN-18 — Equipe - Novo / Editar Advogado

## Objetivo

Cadastro e edição de foto, nome, cargo, OAB, biografia, áreas de atuação, contatos, redes sociais, ordem, destaque e status.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/equipe/novo e /admin/equipe/:id/editar`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/18 - Equipe - Novo - Editar Advogado.png`

# FE-ADMIN-19 — Home - Gerenciamento

## Objetivo

Gerenciamento das seções da página inicial, permitindo ativar, desativar, editar e alterar a ordem dos blocos.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/home`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/19 - Home - Gerenciamento.png`

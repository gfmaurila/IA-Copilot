# FE-ADMIN-13 — Usuários - Novo / Editar

## Objetivo

Cadastro e edição de usuários, dados de acesso, perfil e permissões.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/usuarios/novo e /admin/usuarios/:id/editar`

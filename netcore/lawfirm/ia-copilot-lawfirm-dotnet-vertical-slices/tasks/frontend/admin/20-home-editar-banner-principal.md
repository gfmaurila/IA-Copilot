# FE-ADMIN-20 — Home - Editar Banner Principal

## Objetivo

Configuração do título, subtítulo, imagem de fundo, botões e chamadas principais da Home.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/home/banner`

# FE-ADMIN-26 — Home - Chamada para Ação (CTA)

## Objetivo

Configuração do título, texto, imagem e botão da chamada para contato da página inicial.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/home/cta`

# FE-ADMIN-21 — Home - Editar Seção Sobre

## Objetivo

Configuração dos textos, imagens e links da apresentação institucional exibida na Home.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/home/sobre`

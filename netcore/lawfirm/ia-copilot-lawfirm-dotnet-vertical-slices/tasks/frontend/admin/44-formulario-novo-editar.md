# FE-ADMIN-44 — Formulário - Novo / Editar

## Objetivo

Configuração dos campos, obrigatoriedades, mensagens e comportamento de um formulário.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/formularios/novo e /admin/formularios/:id/editar`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- Não existe mockup PNG específico para esta tela. Seguir rigorosamente o design system e os padrões visuais das telas existentes do mesmo módulo.

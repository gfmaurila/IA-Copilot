# FE-ADMIN-31 — SEO - Configurações Gerais

## Objetivo

Configuração do meta title padrão, meta description, palavras-chave e informações gerais de SEO.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/seo`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/31 - SEO - Configurações Gerais.png`

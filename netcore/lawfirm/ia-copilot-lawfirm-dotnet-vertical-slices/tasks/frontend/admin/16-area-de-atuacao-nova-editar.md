# FE-ADMIN-16 — Área de Atuação - Nova / Editar

## Objetivo

Cadastro e edição de nome, descrição, ícone, imagem, conteúdo, ordem, destaque, status e SEO.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/areas-atuacao/nova e /admin/areas-atuacao/:id/editar`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/16 - Área de Atuação - Nova - Editar.png`

# FE-ADMIN-49 — Política de Privacidade - Editar

## Objetivo

Gerenciamento do conteúdo da página de Política de Privacidade.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/paginas/politica-privacidade`

# FE-ADMIN-35 — Redes Sociais

## Objetivo

Configuração dos links de Instagram, LinkedIn, Facebook, YouTube, X, WhatsApp e outras redes.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/configuracoes/redes-sociais`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/35 - Redes Sociais.png`

# FE-ADMIN-12 — Usuários - Listagem

## Objetivo

Gerenciamento dos usuários que possuem acesso ao painel administrativo.
...
- `docs/screens/1. Front End/admim/12 - Usuários - Listagem.png`

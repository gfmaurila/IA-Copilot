# FE-ADMIN-40 — Redefinir Senha

## Objetivo

Tela para informar a nova senha, confirmar a senha e concluir a recuperação da conta.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/redefinir-senha`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/40 - Redefinir Senha.png`

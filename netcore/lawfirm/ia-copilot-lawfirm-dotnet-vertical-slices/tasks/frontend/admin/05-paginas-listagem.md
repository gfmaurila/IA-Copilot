# FE-ADMIN-05 — Páginas - Listagem

## Objetivo

Listagem e gerenciamento das páginas institucionais do site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/paginas`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/05 - Páginas - Listagem.png`

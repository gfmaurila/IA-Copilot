# FE-SITE-04 — Detalhe da Área de Atuação

## Objetivo

Página individual de uma especialidade jurídica, apresentando descrição completa, informações relacionadas e chamada para contato.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `/areas-de-atuacao/:slug`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/site/04 - Detalhe da Área de Atuação.png`

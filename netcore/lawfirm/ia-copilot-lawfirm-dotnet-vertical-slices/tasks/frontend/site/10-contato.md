...
Página contendo informações de contato, endereço, telefone, WhatsApp, e-mail, mapa e formulário para envio de mensagem.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `/contato`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/site/10 - Contato - 01.png`
- `docs/screens/1. Front End/site/10 - Contato - 02.png`

# FE-SITE-03 — Áreas de Atuação

## Objetivo

Página com a listagem de todas as especialidades e serviços jurídicos oferecidos pelo escritório.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `/areas-de-atuacao`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/site/03 - Áreas de Atuação.png`

# FE-SITE-20 — Menu Mobile

## Objetivo

Versão expandida da navegação principal para smartphones e dispositivos móveis.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `componente global do cabeçalho em viewport mobile`

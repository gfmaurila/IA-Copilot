# FE-SITE-11 — Confirmação de Envio do Contato

## Objetivo

Tela exibida após o envio correto do formulário, confirmando que a mensagem foi recebida.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `/contato/enviado`

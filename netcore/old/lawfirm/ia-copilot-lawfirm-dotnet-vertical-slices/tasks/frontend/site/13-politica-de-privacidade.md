# FE-SITE-13 — Política de Privacidade

## Objetivo

Página contendo as informações sobre privacidade e tratamento de dados pessoais.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `/politica-de-privacidade`

# FE-SITE-19 — Nenhum Resultado Encontrado

## Objetivo

Estado de tela utilizado quando uma busca, filtro ou listagem não possui resultados.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `estado reutilizável em listagens e busca`

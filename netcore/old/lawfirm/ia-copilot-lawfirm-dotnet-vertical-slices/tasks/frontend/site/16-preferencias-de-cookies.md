# FE-SITE-16 — Preferências de Cookies

## Objetivo

Modal ou tela para o visitante escolher quais categorias de cookies deseja permitir.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `componente/modal global de preferências de cookies`

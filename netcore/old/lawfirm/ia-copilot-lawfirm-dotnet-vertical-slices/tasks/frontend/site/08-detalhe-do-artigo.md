# FE-SITE-08 — Detalhe do Artigo

## Objetivo

Página para leitura completa de um artigo, contendo título, imagem, data, autor, conteúdo e informações relacionadas.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `/artigos/:slug`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/site/08 - Detalhe do Artigo - 01.png`
- `docs/screens/1. Front End/site/08 - Detalhe do Artigo - 02.png`

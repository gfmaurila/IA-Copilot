# FE-SITE-06 — Perfil do Advogado

## Objetivo

Página individual do profissional contendo foto, nome, cargo, OAB, biografia, áreas de atuação, informações profissionais e redes sociais.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `site`
- Rota sugerida: `/equipe/:slug`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/site/06 - Perfil do Advogado.png`

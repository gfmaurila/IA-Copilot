# FE-ADMIN-22 — Home - Áreas de Atuação em Destaque

## Objetivo

Seleção das áreas de atuação que serão apresentadas na página inicial.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/home/areas-destaque`

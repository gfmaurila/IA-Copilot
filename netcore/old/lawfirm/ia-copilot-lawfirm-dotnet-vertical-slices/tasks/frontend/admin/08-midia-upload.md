# FE-ADMIN-08 — Mídia - Upload

## Objetivo

Tela para envio de novas imagens e arquivos para a biblioteca de mídia.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/midia/upload`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/08 - Mídia - Upload.png`

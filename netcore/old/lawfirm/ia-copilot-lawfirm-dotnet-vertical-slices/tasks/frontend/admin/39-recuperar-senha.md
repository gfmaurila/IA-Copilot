# FE-ADMIN-39 — Recuperar Senha

## Objetivo

Tela para informar o e-mail e solicitar o envio do link de recuperação de senha.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/recuperar-senha`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/39 - Recuperar Senha.png`

# FE-ADMIN-07 — Mídia - Biblioteca

## Objetivo

Gerenciamento de imagens, arquivos e outros conteúdos utilizados no site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/midia`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/07 - Mídia - Biblioteca.png`

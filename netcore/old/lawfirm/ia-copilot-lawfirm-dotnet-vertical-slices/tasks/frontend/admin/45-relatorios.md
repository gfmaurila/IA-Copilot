# FE-ADMIN-45 — Relatórios

## Objetivo

Visualização de informações e indicadores relacionados aos conteúdos, formulários e utilização do site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/relatorios`

# FE-ADMIN-36 — Integrações

## Objetivo

Configuração de serviços externos utilizados pelo site, como Google Analytics, Google Tag Manager, Google Maps e WhatsApp.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/configuracoes/integracoes`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/36 - Integrações.png`

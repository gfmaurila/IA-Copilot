# FE-ADMIN-28 — Contato - Detalhe da Mensagem

## Objetivo

Visualização completa da mensagem, dados do contato, status e observações administrativas.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/contato/mensagens/:id`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/28 - Contato - Detalhe da Mensagem.png`

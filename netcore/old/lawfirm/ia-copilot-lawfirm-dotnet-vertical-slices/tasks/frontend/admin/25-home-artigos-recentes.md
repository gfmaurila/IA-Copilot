# FE-ADMIN-25 — Home - Artigos Recentes

## Objetivo

Configuração da quantidade e dos conteúdos recentes apresentados na página inicial.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/home/artigos-recentes`

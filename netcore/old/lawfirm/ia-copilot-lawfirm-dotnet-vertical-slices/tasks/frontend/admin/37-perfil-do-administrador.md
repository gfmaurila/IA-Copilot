# FE-ADMIN-37 — Perfil do Administrador

## Objetivo

Gerenciamento dos dados pessoais e informações da conta do administrador.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/perfil`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/37 - Perfil do Administrador.png`

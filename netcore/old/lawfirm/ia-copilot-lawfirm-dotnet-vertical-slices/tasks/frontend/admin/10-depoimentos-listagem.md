# FE-ADMIN-10 — Depoimentos - Listagem

## Objetivo

Listagem e gerenciamento dos depoimentos exibidos no site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/depoimentos`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/10 - Depoimentos - Listagem.png`

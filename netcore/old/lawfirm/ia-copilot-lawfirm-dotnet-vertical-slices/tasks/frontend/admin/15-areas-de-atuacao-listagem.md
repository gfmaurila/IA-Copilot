# FE-ADMIN-15 — Áreas de Atuação - Listagem

## Objetivo

Listagem e gerenciamento das especialidades jurídicas exibidas no site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/areas-atuacao`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/15 - Áreas de Atuação - Listagem.png`

# FE-ADMIN-30 — Rodapé - Configuração

## Objetivo

Configuração da logo, descrição, endereço, telefones, WhatsApp, e-mail, links, áreas de atuação, redes sociais e copyright.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/configuracoes/rodape`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/30 - Rodapé - Configuração.png`

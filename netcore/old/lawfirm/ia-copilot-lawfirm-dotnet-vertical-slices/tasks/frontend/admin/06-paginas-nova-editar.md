# FE-ADMIN-06 — Páginas - Nova / Editar

## Objetivo

Cadastro e edição de páginas, conteúdo, URL, status e configurações de SEO.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/paginas/novo e /admin/paginas/:id/editar`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/06 - Páginas - Nova - Editar - 01.png`
- `docs/screens/1. Front End/admim/06 - Páginas - Nova - Editar - 02.png`

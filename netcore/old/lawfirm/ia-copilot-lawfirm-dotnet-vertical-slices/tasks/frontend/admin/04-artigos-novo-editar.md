# FE-ADMIN-04 — Artigos - Novo / Editar

## Objetivo

Cadastro e edição de artigos, conteúdo, imagem, categoria, status e SEO.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/artigos/novo e /admin/artigos/:id/editar`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/04 - Artigos - Novo - Editar.png`

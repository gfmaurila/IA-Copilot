# FE-ADMIN-17 — Equipe - Listagem

## Objetivo

Listagem e gerenciamento dos profissionais exibidos no site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/equipe`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/17 - Equipe - Listagem.png`

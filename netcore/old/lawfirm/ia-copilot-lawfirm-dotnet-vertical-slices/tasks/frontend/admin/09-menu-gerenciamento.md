# FE-ADMIN-09 — Menu - Gerenciamento

## Objetivo

Configuração dos itens, links, ordem e estrutura do menu principal do site.

## Aplicação

- Frontend: React + TypeScript + Vite
- Módulo: `admin`
- Rota sugerida: `/admin/menu`
- Seguir: `tasks/rules/frontend.md`

## Referência visual

- `docs/screens/1. Front End/admim/09 - Menu - Gerenciamento.png`

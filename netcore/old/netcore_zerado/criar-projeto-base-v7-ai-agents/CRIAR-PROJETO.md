...
> **Versão v7:** antes de implementar este projeto, execute o fluxo multiagente definido em `AGENTS.md` e `orchestration/workflows/PROJECT_CREATION.md`. Os requisitos, arquitetura e plano de execução devem ser materializados em `tasks/generated/`.

...
5. Ao iniciar o backend, configure EF Core/SQL Server, `ApplicationDbContext`, mappings e crie a migration `InitialCreate` antes de CQRS/JWT/APIs.
6. Valide a migration com `dotnet ef migrations script`.
7. Implemente o restante da Spec.
8. Execute build e testes.
9. Corrija erros antes de concluir.
